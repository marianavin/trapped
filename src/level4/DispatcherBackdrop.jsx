...
export default function DispatcherBackdrop() {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <rect x="0" y="0" width="360" height="640" fill="#12132B" />
      ...
      <rect x="40" y="60" width="220" height="260" fill="#12132B" stroke="#2DE8FF" strokeWidth="4" opacity="0.8" />
      <Building x={44} y={200} width={40} height={116} body="#1B1D45" bodyDark="#0B0C1F" litColor="#2DE8FF" dimColor="#CFEFFF" seed={0} />
      <Building x={86} y={160} width={34} height={156} body="#232659" bodyDark="#0B0C1F" litColor="#2DE8FF" dimColor="#CFEFFF" seed={1} />
      <Building x={122} y={210} width={44} height={106} body="#1B1D45" bodyDark="#0B0C1F" litColor="#2DE8FF" dimColor="#CFEFFF" seed={2} />
      <Building x={200} y={180} width={36} height={136} body="#232659" bodyDark="#0B0C1F" litColor="#2DE8FF" dimColor="#CFEFFF" seed={1} />
      <Building x={238} y={220} width={20} height={96} body="#1B1D45" bodyDark="#0B0C1F" litColor="#2DE8FF" dimColor="#CFEFFF" seed={3} />
      {/* window cross-bars */}
