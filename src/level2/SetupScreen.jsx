...
export default function SetupScreen({ onDone }) {
  ...
  return (
    <div className="h-full w-full flex flex-col items-center justify-center bg-l2-bg text-l2-text px-6 text-center gap-3">
      {SETUP_LINES.slice(0, lineIndex + 1).map((line) => (
        <motion.p
          key={line}
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
